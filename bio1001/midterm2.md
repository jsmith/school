...
## Initiation
The initiator codon is **AUG** which adds the **met** amino acid. The anticodon is located on the **initiator tRNA**. The **mRNA binding site** is located on the small subunit. After, the large subunit is added to form the **translation initiation complex**.
...
For example, **kinase** is an enzyme which phosphorylates proteins to add a phosphate group (**phosphorylation**).
