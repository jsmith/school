...
Plants have two photosystems connected by an electron transport chain. The electrons move from **photosystem II** to **photosystem I** via **peophytin**, the primary electron acceptor at photosystem II. While in photosystem II, electrons are derived from H2O which then fill the vacancies in **P680+**. **Cholorphyll Ao** is the primary electron acceptor in photosystem I. It moves protons into the inner membrane, similar to mitochondria, and also produces NADPH which is sent to the Calvin cycle.
