...
\begin{enumerate}
  ...
  \item \br{Dataset}:
  \item \br{Model}:
  \item \br{KFold}: Implements the KFold cross validation algorithm.
  \item \br{Report}: The object returned from a k-fold cross validation test....
  \item \br{Util}: Utility functions used through the machine learning project.
\end{enumerate}
...
\begin{enumerate}
  \item \br{Adaboost}:
  \item \br{AdaboostModel}:
  \item \br{Multi-Adaboost}:
  \item \br{Multi-AdaboostModel}:
  \item \br{RandomForest}:
  \item \br{RandomForstModel}:
\end{enumerate}
...
\begin{enumerate}
  \item \br{AttributeException}:
  \item \br{DataException}:
  \item \br{FileException}:
  \item \br{PredictionException}:
\end{enumerate}
...
\begin{enumerate}
  \item \br{DistanceFunction}:
  \item \br{Euclidian}:
  \item \br{Hamming}:
\end{enumerate}

\subsubsection{distribution}
This package contains distribution implementations for the Naive Bayes classifier.

\begin{enumerate}
  \item \br{Distribution}:
  \item \br{GaussianDistribution}:
\end{enumerate}

\subsection{nb}
This package contains all of the objects associated with Naive Bayes.

\begin{enumerate}
  \item \br{Attribute}:
  \item \br{BayesException}:
  \item \br{ClassSummary}:
  \item \br{ContinuousAttribute}:
  \item \br{DiscreteAttribute}:
  \item \br{NaiveBayes}:
  \item \br{NaiveBayesModel}:
\end{enumerate}
