...
There exist several techniques for training a classifier using a GAN. These methods all take advantage of the unsupervised aspect of GANs to implement semi-supervised learning. The ability to use GAN for semi-supervised learning also offers a quantitative method to rank different GAN models.
